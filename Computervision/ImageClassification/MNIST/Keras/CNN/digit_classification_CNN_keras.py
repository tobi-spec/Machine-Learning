...
class MNISTDataLoader:
    def __init__(self):
        self.train_images = idx2numpy.convert_from_file("./data/train-images.idx3-ubyte").astype(np.float32)
        self.train_labels = idx2numpy.convert_from_file("./data/train-labels.idx1-ubyte")
        self.test_images = idx2numpy.convert_from_file("./data/t10k-images.idx3-ubyte").astype(np.float32)
