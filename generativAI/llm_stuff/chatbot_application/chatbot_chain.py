...
class ChatbotChain:
    def __init__(self, model, retriever, history_database_path):
        self.model:Runnable = model
        self.retriever: EnsembleRetriever | VectorStoreRetriever = retriever
        self.history_database_path: str = history_database_path
    ...
    def get_session_history(self, session_id: str) -> BaseChatMessageHistory:
        return SQLChatMessageHistory(f"{session_id}", self.history_database_path)
