...
def workflow(model):
    ...
    train_timeseries = train_timeseries.reshape(train_timeseries.shape[0],train_timeseries.shape[1], 1)
    test_timeseries = test_timeseries.reshape(test_timeseries.shape[0], test_timeseries.shape[1], 1)
    ...
    prediction_results = Forecaster(
                                    ...
                                    NeuronalNetworkTypes.CNN).one_step_ahead()
